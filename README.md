...
* 🖼️ **Multimodal Vision & OCR:** Upload photos of handwritten notes, textbook diagrams, or exam questions. Aethera automatically performs OCR and visual reasoning.
...
* ⚡ **Intelligent Local Fallback Engine:** Works seamlessly online with live Gemini 1.5/2.0 Flash Vision AI AND offline with a built-in intelligent fallback engine.
